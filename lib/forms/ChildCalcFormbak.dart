...
class _ChildCalcFormState extends State<ChildCalcForm> {
  ...
  void reseteo(ChildCalcFormBloc formBloc) {
    ...
    formBloc.encephalopatyField.dispatch(UpdateFieldBlocItems(
      ['none_fem', 'grade_1_2', 'grade_3_4'],
    ));

    formBloc.encephalopatyField.updateInitialValue('none_fem');
    formBloc.encephalopatyField
        .updateItems(['none_fem', 'grade_1_2', 'grade_3_4']);
    ...
    print("después del reseteo " +
        "\n bili: " +
        formBloc.bilirubinField.toString() +
        "\n inr: " +
        formBloc.inrField.toString() +
        "\n albumina: " +
        formBloc.albuminField.toString() +
        "\n ence: " +
        formBloc.encephalopatyField.toString() +
        "\n asci: " +
        formBloc.ascitesField.toString());
