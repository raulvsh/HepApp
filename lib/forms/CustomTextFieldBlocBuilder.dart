...
class CustomTextFieldBlocBuilder extends StatefulWidget {
  ...
  /// [CustomTextFieldBlocBuilder.noMaxLength] then only the current length is displayed.
  ///
  ...
  const CustomTextFieldBlocBuilder({
    ...
    this.showSuggestionsWhenIsEmpty = true,
        ...
        assert(maxLength == null ||
            maxLength == CustomTextFieldBlocBuilder.noMaxLength ||
            maxLength > 0),
  ...
  /// to [CustomTextFieldBlocBuilder.noMaxLength] then only the current character count is displayed.
  ///
  /// After [maxLength] characters have been input, additional input
  /// is ignored, unless [maxLengthEnforced] is set to false. The text field
  /// enforces the length with a [LengthLimitingTextInputFormatter], which is
  ...
  ///
  /// This value must be either null, [CustomTextFieldBlocBuilder.noMaxLength], or greater than 0.
  /// If null (the default) then there is no limit to the number of characters
  /// that can be entered. If set to [CustomTextFieldBlocBuilder.noMaxLength], then no limit will
  ...
  @override
  _CustomTextFieldBlocBuilderState createState() =>
