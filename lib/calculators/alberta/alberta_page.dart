...
class MyPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawPoints(pointMode, arrow05, paint);
    canvas.drawPoints(pointMode, arrow06, paint);
    canvas.drawPoints(pointMode, arrow07, paint);
    canvas.drawPoints(pointMode, arrow08, paint);
    canvas.drawPoints(pointMode, arrow09, paint);
    canvas.drawPoints(pointMode, arrow10, paint);
    canvas.drawPoints(pointMode, arrow11, paint);
    canvas.drawPoints(pointMode, arrow12, paint);
    canvas.drawPoints(pointMode, arrow13, paint);
    canvas.drawPoints(pointMode, arrow14, paint);
    canvas.drawPoints(pointMode, arrow15, paint);
    canvas.drawPoints(pointMode, arrow16, paint);
    canvas.drawPoints(pointMode, arrow17, paint);
    canvas.drawPoints(pointMode, arrow18, paint);
    canvas.drawPoints(pointMode, arrow19, paint);
    canvas.drawPoints(pointMode, arrow20, paint);
    canvas.drawPoints(pointMode, arrow21, paint);
    canvas.drawPoints(pointMode, arrow22, paint);
    canvas.drawPoints(pointMode, arrow23, paint);
    canvas.drawPoints(pointMode, arrow24, paint);
    canvas.drawPoints(pointMode, arrow25, paint);
    canvas.drawPoints(pointMode, arrow26, paint);
    canvas.drawPoints(pointMode, arrow27, paint);
    canvas.drawPoints(pointMode, arrow28, paint);
    canvas.drawPoints(pointMode, arrow29, paint);
    canvas.drawPoints(pointMode, arrow30, paint);
    canvas.drawPoints(pointMode, arrow31, paint);
    canvas.drawPoints(pointMode, arrow32, paint);
    canvas.drawPoints(pointMode, arrow33, paint);
    canvas.drawPoints(pointMode, arrow34, paint);
    canvas.drawPoints(pointMode, arrow35, paint);
    canvas.drawPoints(pointMode, arrow36, paint);*/
  }
